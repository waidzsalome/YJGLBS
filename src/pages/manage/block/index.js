...
const HeaderScroll = () => {
  ...
  const headerScrollCol  = [
    ...
    },
    {
      ...
      key: 'href',
      render: (href,id) => (
          <Input placeholder = { href } onChange = {(e)=>{
            const newData = data.map((item) => {
              console.log(id.id,"id");
              if(item.id == id.id) {
                return {
    ...
    },
    {
      ...
      dataIndex: 'isShow',
      render: (isShow,id) => (
          <Switch checkedChildren="显示" unCheckedChildren="隐藏" defaultChecked = {isShow}  onChange = {(checked)=>{
            const newData = data.map((item) => {
              console.log(id.id,"id");
              if(item.id == id.id) {
                return {
    ...
    if(picUrl) {
        return (
            <Fragment>
                ...
                <Upload {...props} onChange = {(info)=>{onChange(info,id)}}>
      <Button>
         修改图片
      </Button>
    </Upload>
